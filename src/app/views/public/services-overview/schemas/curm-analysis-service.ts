// services-data.ts (or inside service-detail.page.ts)
export const CHURN_ANALYSIS_SERVICE = {
  ...
  Our Churn Analysis & Customer Retention Studies service conducts systematic, in-depth interviews with churned customers to uncover the real reasons behind attrition—going beyond surface-level data to reveal patterns, pain points, and preventable causes that traditional analytics miss.`,
    ...
    proximately: [
        {
            title: '10–25% Churn Reduction',
            description: 'Typical range observed within 12 months of implementing recommendations'
        },
        {
            title: 'Direct Bottom-Line Impact',
            description: 'Each 1% reduction in churn = retained revenue and improved unit economics'
        },
        {
            title: 'Stronger Investor Confidence',
            description: 'Clear churn understanding and mitigation plan significantly improves fundraising optics'
        },
        {
            title: 'Better Product & Segmentation Decisions',
            description: 'Customer voice directly informs roadmap and ideal customer profile refinement'
        }
    ],
    ...
    // Bonus: Extra paragraph for "Why This Matters" section
